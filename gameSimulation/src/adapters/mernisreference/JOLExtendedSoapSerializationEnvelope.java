...
public class JOLExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(JOLDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new JOLStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static JOLDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static JOLDateTimeConverter dateTimeConverter = new JOLStandardDateTimeConverter();

    public JOLExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public JOLExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new JOLMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=JOLHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,JOLExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=JOLHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
