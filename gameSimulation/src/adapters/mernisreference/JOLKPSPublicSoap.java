...
public class JOLKPSPublicSoap
{
    ...
    public JOLKPSPublicSoap(){}

    public JOLKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public JOLKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        JOLExtendedSoapSerializationEnvelope envelope= new JOLExtendedSoapSerializationEnvelope(JOLExtendedSoapSerializationEnvelope.VER11);
